        ...
        <div class="col-lg-6">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5">
                    ...
                    <form action="<?= base_url('kader') ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control input-custom" id="nama" name="nama" required>
                        </div>

                        <div class="mb-3">
                            <label for="alamat" class="fw-semibold">Alamat</label>
                            <textarea class="form-control input-custom" id="alamat" name="alamat" rows="3"
                                required></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="lulusan" class="fw-semibold">Lulusan</label>
                            <input type="text" class="form-control input-custom" id="lulusan" name="lulusan" required>
                        </div>

                        <div class="mb-3">
                            <label for="keahlian" class="fw-semibold">Keahlian</label>
                            <input type="text" class="form-control input-custom" id="keahlian" name="keahlian" required>
                        </div>
